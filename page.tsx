...
export default function DashboardPage() {
  ...
  const uniqueStudents = Array.from(new Map(activeSessions.map(s => [s.student_id, s])).values())
  const uniqueTeachers = Array.from(new Map(activeSessions.map(s => [s.teacher_id, s])).values())
